# Release Notes — IntentusNet v4.5
...
IntentusNet v4.5 introduces **provable determinism** — execution behavior can now be cryptographically verified, drift-detected, and CI-enforced. Determinism is no longer just a design property; it is a measurable, enforceable guarantee.
...
| Document | Changes |
|----------|---------|
| README.md | v4.5 badge, What's New section, Provable Determinism section, updated guarantees table |
| docs/roadmap.md | v4.5 as current release, updated near-term and future sections |
...
| Guarantee | Status |
|-----------|--------|
| Execution Fingerprinting | **Provided (v4.5)** |
| Deterministic-Safe CI/CD | **Provided (v4.5)** |
| Drift Detection | **Provided (v4.5)** |

---

## Breaking Changes

None. v4.5 is fully backward-compatible with v4.x.
