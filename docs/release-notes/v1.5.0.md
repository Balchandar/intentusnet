# Release Notes — IntentusNet v1.5.0
...
IntentusNet v1.5.0 introduces **provable determinism** — execution behavior can now be cryptographically verified, drift-detected, and CI-enforced. Determinism is no longer just a design property; it is a measurable, enforceable guarantee.
...
| Document | Changes |
|----------|---------|
| README.md | v1.5.0 badge, What's New section, Provable Determinism section, updated guarantees table |
| docs/roadmap.md | v1.5.0 as current release, updated near-term and future sections |
...
| Guarantee | Status |
|-----------|--------|
| Execution Fingerprinting | **Provided (v1.5.0)** |
| Deterministic-Safe CI/CD | **Provided (v1.5.0)** |
| Drift Detection | **Provided (v1.5.0)** |

---

## Breaking Changes

None. v1.5.0 is fully backward-compatible with v4.x.
